...
#include"decleration.h"
	 ...
	 *
	 * In 05_Nibble we are transfering a single character from one machine to other using nibble mode.... 
	 * Here we are transfering a string instead of a character only
	 */
