...
#include"decleration.h"
	 ...
	 *
	 * In 02_Byte_sender we are just transmitting a character data between 2 machine without acknowledging 
	 * reception of recently sent data..... so Here we are using 'nstrobe(of receiver) - nACK(of sender)' pin duo
