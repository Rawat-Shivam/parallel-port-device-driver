...
#include"decleration.h"
	 ...
	 *
	 * so Instead of writing whole byte all in one go as in compatiblity we are sending original data in patches of 
	 * 4 - 4 bit and following compatiblity mode for each patch from sender side
	 */
